...
public class TestNostrconnectUrl {
    ...
    public void setUp() throws Exception {
        ...
        testMetadata = new Nip46AppMetadata(
                "Test App",
    ...
    public void testToString() {
        ...
        assertTrue(urlString
                .startsWith("nostrconnect://3bf0c63fcb93463407af97a5e5ee64fa883d107ef9e558472c4eb9aaaefa459d?"));
    ...
    public void testParse() throws MalformedURLException, URISyntaxException, UnsupportedEncodingException {
        // Create a URL string
        String urlString = "nostrconnect://3bf0c63fcb93463407af97a5e5ee64fa883d107ef9e558472c4eb9aaaefa459d"
