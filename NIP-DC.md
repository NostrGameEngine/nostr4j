...
New implementations **MUST** emit `dc4`. They **MAY** accept `dc3` for
backward-compatible direct WebRTC/TURN operation. A `dc3` presence does not
advertise routing support and **MUST NOT** be used as a dc4 topology endpoint or
intermediate hop.
