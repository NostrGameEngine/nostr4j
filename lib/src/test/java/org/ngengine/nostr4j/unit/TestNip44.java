...
public class TestNip44 {
    ...
    public void testGetConversationKeyValid() throws Exception {
        JsonArray vectors = testVectors.getAsJsonObject("valid")
    ...
    public void testDecryptInvalid() {
        JsonArray vectors = testVectors.getAsJsonObject("invalid")
        ...
        for (JsonElement element : vectors) {
            ...
            try {
                ...
                boolean matchesNote = message != null &&
                ...
                boolean matchesSpecificError = (note.contains("invalid base64")
                ...
                assertTrue(
                        "Exception message should relate to: " + note +
                                " but was: " + message,
